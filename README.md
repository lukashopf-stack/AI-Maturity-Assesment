...
<div id="screen-home" class="screen active">
  ...
  <div class="page-header">
    <h1 data-de="KI-Bereitschaftsbewertung" data-en="AI Readiness Assessment">KI-Bereitschaftsbewertung</h1>
...
const CAP = [
  ...
  { id:'c3', name:{ de:'KI-Datenzugang & -management', en:'AI Data Accessibility & Management' }, short:{ de:'Datenzugang', en:'Data Accessibility' }, color:'#7C3AED', bg:'#EDE9FE' },
  { id:'c4', name:{ de:'KI-Koordination & Governance', en:'AI Coordination & Governance' }, short:{ de:'Koordination & Governance', en:'Coordination & Governance' }, color:'#0D9488', bg:'#CCFBF1' },
...
const QS = [
  { id:'q01', c:'c1', l:'ia', text:{ de:'Inwieweit verstehen die einzelnen Akteure KI-Chancen?', en:'To what extent do individual actors understand AI opportunities?' }, desc:{ de:'Die Fähigkeit, die aktuellen Möglichkeiten und Grenzen der KI-Technologie zu verstehen und zu erkennen, welche geschäftlichen Probleme für KI-Lösungen geeignet sind.', en:'The ability to understand the current capabilities and limitations of AI technology and recognize which business problems are suitable for AI solutions.' }, opts:{ de:['Gering','Grundlegend','Solide','Fortgeschritten','Ausgereift'], en:['Little','Basic','Solid','Advanced','Mature'] } },
  { id:'q02', c:'c1', l:'ia', text:{ de:'Inwieweit tragen die einzelnen Akteure zur Priorisierung bei?', en:'To what extent do individual actors contribute to prioritization?' }, desc:{ de:'Das Ausmaß, in dem relevante Akteure aktiv Beiträge zur Bewertung und Priorisierung von KI-Initiativen leisten.', en:'The extent to which relevant actors actively provide input for evaluating and ranking AI initiatives.' }, opts:{ de:['Begrenzt','Gelegentlich','Regelmäßig','Konsistent','Proaktiv'], en:['Limited','Occasional','Regular','Consistent','Proactive'] } },
  { id:'q03', c:'c1', l:'ip', text:{ de:'Inwieweit sind Portfolio-Entscheidungsroutinen etabliert?', en:'To what extent are portfolio decision routines established?' }, desc:{ de:'Die organisatorischen Verfahren und Governance-Prozesse, durch die KI-Initiativen genehmigt, abgelehnt, pausiert, skaliert oder eingestellt werden.', en:'The organizational procedures and governance processes through which AI initiatives are approved, rejected, paused, scaled, or discontinued.' }, opts:{ de:['Nicht vorhanden','Ad hoc','Formalisiert','Strukturiert','Kontinuierlich'], en:['Absent','Ad hoc','Formalized','Structured','Continuous'] } },
  { id:'q04', c:'c1', l:'ip', text:{ de:'Inwieweit ist das KI-Portfolio mit strategischen Zielen verknüpft?', en:'To what extent is the AI portfolio linked to strategic goals?' }, desc:{ de:'Der Grad, in dem die Auswahl, Steuerung und Weiterführung von KI-Initiativen mit den übergeordneten strategischen Zielen der Organisation übereinstimmt.', en:'The degree to which the selection, steering, and continuation of AI initiatives are aligned with the organization\'s overarching strategic objectives and priorities.' }, opts:{ de:['Nicht vorhanden','Implizit','Partiell','Konsistent','Nahtlos'], en:['Absent','Implicit','Partial','Consistent','Seamless'] } },
  { id:'q05', c:'c2', l:'ia', text:{ de:'Inwieweit verfügen technische Rollen über KI-Lösungsentwicklungsfähigkeiten?', en:'To what extent do technical roles have AI solution-building skills?' }, desc:{ de:'Die technischen Kompetenzen zur Entwicklung von KI-Modellen, einschließlich Datenvorbereitung, Algorithmus-/Modellauswahl, Use-Case-Entwicklung, Test und Validierung.', en:'The technical competencies required to develop AI models, including data preparation, algorithm/model selection, use-case development, testing, and validation.' }, opts:{ de:['Nicht vorhanden','Entstehend','Vorhanden','Konsistent','Wertschöpfend'], en:['Absent','Emerging','Present','Consistent','Value-delivering'] } },
  { id:'q06', c:'c2', l:'ia', text:{ de:'Inwieweit verfügen technische Rollen über Operationalisierungskompetenzen?', en:'To what extent do technical roles have operationalization skills?' }, desc:{ de:'Die technischen Kompetenzen, die erforderlich sind, um KI-Use-Cases vom Entwicklungsstadium in den Produktionseinsatz zu überführen, einschließlich Deployment und Integration.', en:'The technical competencies required to transition AI use-cases from development into production use, including deployment and integration.' }, opts:{ de:['Nicht vorhanden','Entstehend','Vorhanden','Konsistent','Wertschöpfend'], en:['Absent','Emerging','Present','Consistent','Value-delivering'] } },
  { id:'q07', c:'c2', l:'dt', text:{ de:'Inwieweit sind Versionskontrolle und Deployment-Pipelines etabliert?', en:'To what extent are version control & deployment pipelines established?' }, desc:{ de:'Die technischen Systeme und Prozesse zur Verwaltung von Code-Versionen, Nachverfolgung von Änderungen und Automatisierung des Deployments von KI-Modellen in Produktionsumgebungen.', en:'The technical systems and processes for managing code versions, tracking changes, and automating the deployment of AI models into production environments.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Funktionsfähig','Standardisiert','Automatisiert'], en:['Absent','Basic','Functional','Standardized','Automated'] } },
  { id:'q08', c:'c2', l:'dt', text:{ de:'Inwieweit sind Lösungsüberwachungstools etabliert?', en:'To what extent are solution monitoring tools established?' }, desc:{ de:'Die technischen Systeme und Prozesse zur Überwachung der KI-Modellleistung, Erkennung von Problemen wie Model Drift und Sicherstellung kontinuierlicher Zuverlässigkeit im Produktionsbetrieb.', en:'The technical systems and processes for tracking AI model performance, detecting issues such as model drift, and ensuring continuous reliability in production.' }, opts:{ de:['Nicht vorhanden','Informell','Funktionsfähig','Standardisiert','Automatisiert'], en:['Absent','Informal','Functional','Standardized','Automated'] } },
  { id:'q09', c:'c2', l:'ip', text:{ de:'Inwieweit sind KI-Bereitstellungspraktiken etabliert?', en:'To what extent are AI delivery practices established?' }, desc:{ de:'Die standardisierten organisatorischen Prozesse und Workflows zur Entwicklung, Testung, Deployment und Wartung von KI-Lösungen.', en:'The standardized organizational processes and workflows for moving AI solutions through development, testing, deployment, and maintenance stages.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Strukturiert','Standardisiert','Kontinuierlich verbessert'], en:['Absent','Basic','Structured','Standardized','Continuously improved'] } },
  { id:'q10', c:'c2', l:'ip', text:{ de:'Inwieweit sind IT- und Geschäftsfunktionen bei der KI-Bereitstellung koordiniert?', en:'To what extent are IT & business functions coordinated in AI delivery?' }, desc:{ de:'Die Zusammenarbeit und Abstimmung zwischen IT-Teams und Geschäftsbereichen über den gesamten KI-Bereitstellungslebenszyklus hinweg, von der Anforderungserfassung bis zu Deployment und Wartung.', en:'The collaboration and alignment between IT teams and business throughout the AI delivery lifecycle, from requirements gathering to deployment and maintenance.' }, opts:{ de:['Nicht vorhanden','Reaktiv','Konsistent','Eingebettet','Proaktiv'], en:['Absent','Reactive','Consistent','Embedded','Proactive'] } },
  { id:'q11', c:'c4', l:'ia', text:{ de:'Inwieweit sind Rollen und Verantwortlichkeiten für KI-Projekte den einzelnen Akteuren klar?', en:'To what extent are roles & responsibilities for AI projects clear to individual actors?' }, desc:{ de:'Das Ausmaß, in dem klar definiert ist, wer für KI-bezogene Aufgaben verantwortlich ist, einschließlich strategischer Aufsicht, Projektdurchführung, Daten-Governance und operativer Verantwortlichkeiten.', en:'The extent to which it is clearly defined who is accountable for AI-related tasks, including strategic oversight, project delivery, data governance, and operational responsibilities.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Etabliert','Konsistent','Eingebettet'], en:['Absent','Basic','Established','Consistent','Embedded'] } },
  { id:'q12', c:'c4', l:'ia', text:{ de:'Inwieweit sind Entscheidungsbefugnisse für KI den einzelnen Akteuren klar?', en:'To what extent are decision rights for AI clear to individual actors?' }, desc:{ de:'Das Ausmaß, in dem klar definiert ist, wer die Befugnis hat, Entscheidungen über KI-Initiativen zu treffen, einschließlich Genehmigungen, Ressourcenzuteilung, Priorisierung und Projektfortsetzung oder -abbruch.', en:'The extent to which it is clearly defined who has the authority to make decisions about AI initiatives, including approvals, resource allocation, prioritization, and project continuation or termination.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Etabliert','Konsistent','Eingebettet'], en:['Absent','Basic','Established','Consistent','Embedded'] } },
  { id:'q13', c:'c4', l:'ip', text:{ de:'Inwieweit sind Entscheidungsbefugnisse und -prozesse für KI etabliert?', en:'To what extent are decision rights & processes for AI established?' }, desc:{ de:'Die Governance-Strukturen und Genehmigungsmechanismen, durch die Entscheidungen zu KI-Projekten getroffen, eskaliert und dokumentiert werden.', en:'The governance structures and approval mechanisms through which AI-project decisions are made, escalated, and documented across the organization.' }, opts:{ de:['Nicht vorhanden','Informell','Definiert','Konsistent angewendet','Kontinuierlich verbessert'], en:['Absent','Informal','Defined','Consistently applied','Continuously improved'] } },
  { id:'q14', c:'c4', l:'ip', text:{ de:'Inwieweit sind relevante Stakeholder in KI-bezogene Entscheidungen und Aktivitäten eingebunden?', en:'To what extent are relevant stakeholders involved in AI-related decisions and activities?' }, desc:{ de:'Das Ausmaß, in dem relevante organisatorische Akteure, darunter Geschäftsbereiche, IT, Datenteams, Compliance und Endnutzer, über den gesamten KI-Projektlebenszyklus hinweg eingebunden sind.', en:'The extent to which relevant organizational actors, including business units, IT, data teams, compliance, and end users, are engaged throughout AI project lifecycles.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Strukturiert','Konsistent','Kontinuierlich'], en:['Absent','Basic','Structured','Consistent','Continuous'] } },
  { id:'q15', c:'c3', l:'ia', text:{ de:'Inwieweit sind Geschäftsrollen über Datenanforderungen und -chancen für KI informiert?', en:'To what extent are business roles aware of data requirements and opportunities for AI?' }, desc:{ de:'Das Ausmaß, in dem Geschäftsrollen die Datenanforderungen für KI verstehen und aktiv an der Datenerfassung und -verbesserung teilnehmen.', en:'The extent to which business roles understand data requirements for AI and actively participate in data collection and improvement.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Etabliert','Proaktiv','Botschaftsgeleitet'], en:['Absent','Basic','Established','Proactive','Advocacy-driven'] } },
  { id:'q16', c:'c3', l:'ia', text:{ de:'Inwieweit unterstützen und steuern technische Rollen Datenpraktiken für KI?', en:'To what extent do technical roles support and govern data practices for AI?' }, desc:{ de:'Die Kompetenzen und Routinen technischer Teams zur Erhebung, Strukturierung, Integration, Kuratierung und Pflege von Daten zur Erfüllung von KI-Qualitäts- und Zugänglichkeitsstandards.', en:'The competencies and routines of technical teams to collect, structure, integrate, curate, and maintain data to meet AI quality and accessibility standards.' }, opts:{ de:['Reaktiv','Unterstützend','Standardsetzend','Governance-führend','Kontinuierlich verfeinernd'], en:['Reactive','Supportive','Standards-enforcing','Governance-leading','Continuously refining'] } },
  { id:'q17', c:'c3', l:'dt', text:{ de:'Inwieweit ist die Dateninfrastruktur strukturiert und skalierbar für den KI-Einsatz?', en:'To what extent is the data infrastructure structured and scalable for AI use?' }, desc:{ de:'Die technischen Systeme und Plattformen zur Speicherung, Verarbeitung und Bereitstellung von Daten, die für KI-Modellentwicklung, Deployment und Betrieb erforderlich sind.', en:'The technical systems and platforms for storing, processing, and providing access to data required for AI model development, deployment, and operation.' }, opts:{ de:['Begrenzt','Grundlegend','Strukturiert','Skalierbar','Elastisch'], en:['Limited','Basic','Structured','Scalable','Elastic'] } },
  { id:'q18', c:'c3', l:'dt', text:{ de:'Inwieweit sind Daten systemübergreifend und für Stakeholder für den KI-Einsatz zugänglich?', en:'To what extent is data accessible across systems and stakeholders for AI use?' }, desc:{ de:'Das Ausmaß, in dem relevante Daten von autorisierten Teams und Stakeholdern in der gesamten Organisation für KI-Zwecke aufgefunden, abgerufen und genutzt werden können.', en:'The extent to which relevant data can be discovered, retrieved, and used by authorized teams and stakeholders across the organization for AI purposes.' }, opts:{ de:['Begrenzt','In Silos','Partiell','Konsistent','Interoperabel'], en:['Limited','Siloed','Partial','Consistent','Interoperable'] } },
  { id:'q19', c:'c3', l:'ip', text:{ de:'Inwieweit sind Datenzugangs- und Bearbeitungsrechte definiert?', en:'To what extent are data access & editing rights defined for data?' }, desc:{ de:'Die formalen Richtlinien und Berechtigungen, die festlegen, wer auf bestimmte Datenassets für KI-Entwicklung und -Deployment zugreifen, diese nutzen und teilen darf.', en:'The formal policies and permissions that define who can access, use, and share specific data assets for AI development and deployment.' }, opts:{ de:['Nicht definiert','Informell','Definiert','Durchgesetzt','Kontinuierlich verfeinert'], en:['Undefined','Informal','Defined','Enforced','Continuously refined'] } },
  { id:'q20', c:'c3', l:'ip', text:{ de:'Inwieweit sind Datenqualitätsprozesse zur Sicherstellung zuverlässiger Daten für KI etabliert?', en:'To what extent are data quality processes established to ensure reliable data for AI use?' }, desc:{ de:'Die organisatorischen Routinen und Standards zur Sicherstellung von Datengenauigkeit, Vollständigkeit, Konsistenz und Zuverlässigkeit über den gesamten KI-Lebenszyklus hinweg.', en:'The organizational routines and standards for ensuring data accuracy, completeness, consistency, and reliability across the AI lifecycle.' }, opts:{ de:['Nicht vorhanden','Inkonsistent','Grundlegend','Zuverlässigkeitsgetrieben','Kontinuierlich verbessert'], en:['Absent','Inconsistent','Basic','Reliability-driven','Continuously improved'] } },
  { id:'q21', c:'c5', l:'ia', text:{ de:'Inwieweit sind Geschäftsrollen über KI-bezogene Risiken und ethische Bedenken informiert und dafür verantwortlich?', en:'To what extent are business roles aware of and responsible for AI-related risks & ethical concerns?' }, desc:{ de:'Das Ausmaß, in dem Geschäfts-Stakeholder ethische, rechtliche, sicherheitsrelevante, datenschutzrechtliche und qualitätsbezogene Risiken im Zusammenhang mit KI verstehen und die Verantwortung für deren Identifizierung und Eskalation übernehmen.', en:'The extent to which business stakeholders understand ethical, legal, security, privacy, and quality risks associated with AI and take responsibility for identifying and escalating them.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Etabliert','Konsistent','Proaktiv'], en:['Absent','Basic','Established','Consistent','Proactive'] } },
  { id:'q22', c:'c5', l:'ia', text:{ de:'Inwieweit identifizieren, bewerten und adressieren technische Rollen KI-bezogene Risiken und ethische Bedenken in der Praxis?', en:'To what extent do technical roles identify, assess, and address AI-related risks & ethical concerns in practice?' }, desc:{ de:'Die Kompetenzen und Routinen technischer Teams zur Identifizierung, Bewertung, Dokumentation und Minderung ethischer, rechtlicher, sicherheitsrelevanter, datenschutzrechtlicher und qualitätsbezogener Risiken über den gesamten KI-Lebenszyklus hinweg.', en:'The competencies and routines of technical teams to identify, assess, document, and mitigate ethical, legal, security, privacy, and quality risks throughout the AI lifecycle.' }, opts:{ de:['Nicht vorhanden','Entstehend','Definiert','Durchgesetzt','Kontinuierlich verfeinert'], en:['Absent','Emerging','Defined','Enforced','Continuously refined'] } },
  { id:'q23', c:'c5', l:'dt', text:{ de:'Inwieweit sind KI-Ethik- und Risikobewertungstools etabliert?', en:'To what extent is AI ethics & risk assessment tooling established?' }, desc:{ de:'Die technischen Systeme und Methoden zur systematischen Bewertung von KI-bezogenen Risiken, einschließlich Modelltests, Bias-Erkennung, Sicherheitsscans und Compliance-Prüfungen.', en:'The technical systems and methods for systematically evaluating AI-related risks, including model testing, bias detection, security scanning, and compliance checking.' }, opts:{ de:['Nicht vorhanden','Grundlegend','Standard','Systematisch','Automatisiert'], en:['Absent','Basic','Standard','Systematic','Automated'] } },
  { id:'q24', c:'c5', l:'ip', text:{ de:'Inwieweit sind KI-Ethik- und Risikoüberprüfungsroutinen etabliert?', en:'To what extent are AI ethics & risk review routines established?' }, desc:{ de:'Die organisatorischen Prozesse zur regelmäßigen Überprüfung von KI-Systemen und -Projekten, um aufkommende Risiken zu identifizieren und zu beurteilen, ob Minderungsmaßnahmen weiterhin wirksam sind.', en:'The organizational processes for regularly reviewing AI systems and projects to identify emerging risks and assess whether mitigation measures remain effective.' }, opts:{ de:['Nicht vorhanden','Verstreut','Definiert','Konsistent','Wiederkehrend'], en:['Absent','Scattered','Defined','Consistent','Recurring'] } },
  { id:'q25', c:'c5', l:'ip', text:{ de:'Inwieweit sind Eskalationswege für KI-bezogene Risiken und ethische Fragen etabliert?', en:'To what extent are escalation paths for AI-related risks and ethical issues established?' }, desc:{ de:'Die Verfahren und Berichtsstrukturen, durch die identifizierte KI-Risiken an die zuständigen Entscheidungsträger zur Lösung oder Minderung kommuniziert werden.', en:'The procedures and reporting structures through which identified AI risks are communicated to appropriate decision-makers for resolution or mitigation action.' }, opts:{ de:['Nicht vorhanden','Inkonsistent','Definiert','Durchgesetzt','Eingebettet'], en:['Absent','Inconsistent','Defined','Enforced','Embedded'] } },
];

const OQS = [
  { id:'oq1', text:{ de:'Gibt es wichtige Aspekte der KI-Bereitschaft, die Ihrer Meinung nach in dieser Bewertung fehlen?', en:'Are there any important aspects of AI readiness that you believe are missing from this assessment?' }, type:'text' },
  { id:'oq2', text:{ de:'Auf einer Skala von 1 bis 5: Wie gut ist Ihre Organisation Ihrer Meinung nach in der Lage, KI erfolgreich einzusetzen?', en:'On a scale from 1 to 5, how able do you think your organization is to implement AI successfully?' }, type:'rating' },
  { id:'oq3', text:{ de:'Hat sich Ihre Einschätzung der KI-Fähigkeit Ihrer Organisation nach dem Ausfüllen dieser Befragung verändert?', en:'After completing this survey, did your view of your organization\'s ability to implement AI successfully differ from your initial perception?' }, type:'select', opts:{ de:['Nein, ungefähr gleich','Ja, etwas','Ja, erheblich','Nicht sicher'], en:['No, it was about the same','Yes, somewhat','Yes, significantly','Not sure'] } },
  { id:'oq4', text:{ de:'Wie hat sich Ihre Einschätzung verändert?', en:'How did your perception change?' }, type:'text' },
];
